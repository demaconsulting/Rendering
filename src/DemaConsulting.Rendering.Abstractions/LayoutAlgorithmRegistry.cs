...
/// <summary>
/// A lookup of <see cref="LayoutAlgorithmBase"/> implementations keyed by <see cref="LayoutAlgorithmBase.Id"/>.
...
{
    private readonly Dictionary<string, LayoutAlgorithmBase> _algorithms =
